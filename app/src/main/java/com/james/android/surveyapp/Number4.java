...
public class Number4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SleepFirstrbsecsec = findViewById(R.id.SleepFirstrbsecgg);

        secondsleep1 = findViewById(R.id.sleepsec23);
        ...
        nextBtn1st.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Number4.this, "Please choose at least one!",
                ...
                userData.put("Number 4", (String) secondsleep1.getText());

...
public class Number2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SleepFirstrbsecsec = findViewById(R.id.SleepFirstrbsecsec);

        secondsleep1 = findViewById(R.id.secondsleep1);
        ...
        nextBtn1st.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Number2.this, "Please choose at least one!",
                    ...
                    userData.put("Number 2", (String) secondsleep1.getText());

...
public class Number3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SleepFirstrbsecsec = findViewById(R.id.SleepFirstrbsec);

        secondsleep1 = findViewById(R.id.sleepsec2);
        ...
        nextBtn1st.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Number3.this, "Please choose at least one!",
                ...
                userData.put("Number 3", (String) secondsleep1.getText());

...
public class Number9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SleepFirstrbsecsec = findViewById(R.id.SleepFirstrbsedac);

        secondsleep1 = findViewById(R.id.sleepsrwec2);
        ...
        nextBtn1st.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Number9.this, "Please choose at least one!",
                ...
                userData.put("Number 9", (String) secondsleep1.getText());

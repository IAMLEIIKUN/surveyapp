...
public class Number7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SleepFirstrbsecsec = findViewById(R.id.SleepFirstrqbsec);

        secondsleep1 = findViewById(R.id.sleepnsec2);
        ...
        nextBtn1st.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Number7.this, "Please choose at least one!",
                ...
                userData.put("Number 7", (String) secondsleep1.getText());

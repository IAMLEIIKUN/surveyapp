...
public class Number6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SleepFirstrbsecsec = findViewById(R.id.SleepFirstyrbsec);

        secondsleep1 = findViewById(R.id.sleepesec2);
        ...
        nextBtn1st.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Number6.this, "Please choose at least one!",
                ...
                userData.put("Number 6", (String) secondsleep1.getText());

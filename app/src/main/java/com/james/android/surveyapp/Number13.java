...
public class Number13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SleepFirstrbsecsec = findViewById(R.id.SleepFirtwestrfgbsvcdedac);

        secondsleep1 = findViewById(R.id.sltezepsrwderec2);
        ...
        nextBtn1st.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Number13.this, "Please choose at least one!",
                ...
                userData.put("Number 13", (String) secondsleep1.getText());
                mDatabase.updateChildren(userData);

                Intent intent = new Intent(getApplicationContext(), Number14.class);

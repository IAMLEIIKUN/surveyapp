...
public class Number19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SleepFirstrbsecsec = findViewById(R.id.Sl46gsacg);

        secondsleep1 = findViewById(R.id.seqy64c2h);
        ...
        nextBtn1st.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Number19.this, "Please choose at least one!",
                ...
                userData.put("Number 19", (String) secondsleep1.getText());
                mDatabase.updateChildren(userData);

                Intent intent = new Intent(getApplicationContext(), Number20.class);

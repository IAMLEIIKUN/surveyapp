...
public class Number12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SleepFirstrbsecsec = findViewById(R.id.SleepFirtwestrbsvcdedac);

        secondsleep1 = findViewById(R.id.slteepsrwderec2);
        ...
        nextBtn1st.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Number12.this, "Please choose at least one!",
                ...
                userData.put("Number 12", (String) secondsleep1.getText());
                mDatabase.updateChildren(userData);

                Intent intent = new Intent(getApplicationContext(), Number13.class);

...
public class Number5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SleepFirstrbsecsec = findViewById(R.id.SleepFirstrbseca);

        secondsleep1 = findViewById(R.id.sleepsaec2);
        ...
        nextBtn1st.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Number5.this, "Please choose at least one!",
                ...
                userData.put("Number 5", (String) secondsleep1.getText());

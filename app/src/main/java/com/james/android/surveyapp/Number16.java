...
public class Number16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SleepFirstrbsecsec = findViewById(R.id.Sle21sdgac);

        secondsleep1 = findViewById(R.id.seqrxeasc2);
        ...
        nextBtn1st.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Number16.this, "Please choose at least one!",
                ...
                userData.put("Number 16", (String) secondsleep1.getText());
                mDatabase.updateChildren(userData);

                Intent intent = new Intent(getApplicationContext(), Number17.class);
